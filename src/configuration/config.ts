...
//  Number of buildings in the system. 
export const numBuildings = 5;
...
export const floorsConfig: number[] = [8,3,4];

// Default number of elevators if not specified in the configuration.
export const defaultConfigElevators = 2;

// Default number of floors if not specified in the configuration.
export const defaultConfigFloors = 5;
